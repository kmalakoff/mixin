...
(function() {
  ...
  $(document).ready(function() {
    ...
    if (!Mixin.AutoMemory && (typeof require !== 'undefined')) {
      require('lib/mixin-auto-memory');
    }
    ...
    test("autoFunction common usage", function() {
      ...
      AutoFunctionCommon = (function() {
        ...
        function AutoFunctionCommon() {
          ...
          this.autoFunction(this.prop2, function(prop) {
            if (prop !== _this.prop2) {
          ...
          this.autoFunction(this, function(that) {
            if (that !== _this) {
