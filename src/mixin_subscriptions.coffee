...
throw new Error("Mixin.Subscriptions: Dependency alert! Mixin is missing. Please ensure it is included") if not Mixin
throw new Error('Mixin.Subscriptions: Dependency alert! Underscore.js must be included before this file') if not _.VERSION
throw new Error("Mixin.Subscriptions: Dependency alert! Underscore-Awesomer.js must be included before this file") if not _.AWESOMENESS
